...
const faqs: Faq[] = [
  {
    ...
    answer: "A pharmaceutical import license and regulatory approvals are needed."
  },
  {
    question: "How do you ensure quality?",
    answer: "We source from certified manufacturers and follow GMP standards."
  },
  {
    question: "What products do you import?",
    answer: "Prescription drugs, OTC medications, vaccines, and medical supplies."
  },
  {
    question: "How do you handle customs?",
    answer: "We manage all permits and work with customs for smooth clearance."
  }
];
...
const Faq = () => {
  return (
    <section className="relative z-20 overflow-hidden bg-white pb-8 pt-10 lg:pb-[50px] lg:pt-[40px]">
      <div className="container">
        <SectionTitle
          subtitle="Frequently Asked Questions"
          title="Frequently Asked Questions"
          paragraph="Find quick answers to common questions about our products and services."
          width="640px"
          center
        />
