    ...
    <section className="pb-4 pt-[120px] md:pt-[130px] lg:pb-8 lg:pt-[130px]">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mb-12 text-center">
          ...
          East Gafat Engineering Group is a global leader in providing sustainable, high-quality
        ...
        <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-2">
          ...
          <div>
            ...
            East Gafat Engineering Group is a dynamic and innovative company committed to
